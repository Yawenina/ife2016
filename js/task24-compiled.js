...
function traverseBF(node) {
	var list = [];
	list.push(node);
	var currentDiv = list.shift();

	while (currentDiv) {
		for (var i = 0, len = currentDiv.children.length; i < len; i++) {
...
function search() {
	...
	var i = divList.findIndex(function (elem) {
...
//# sourceMappingURL=task24-compiled.js.map